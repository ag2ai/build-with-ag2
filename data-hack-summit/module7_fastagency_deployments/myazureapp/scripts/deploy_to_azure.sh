...
# Variables
export RESOURCE_GROUP="myazureapprg"
export CONTAINER_APP_NAME="myazureapp"
export LOCATION="eastus"
export ACR_NAME="myazureappacr2"
export VNET_NAME="myazureapp-vnet"
az acr update -n myazureappacr --admin-enabled true
