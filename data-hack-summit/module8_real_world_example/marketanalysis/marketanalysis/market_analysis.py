...
def openai_review(analysis, swot):
    ...
    feedback = {
        ...
        "comments": "Add more trends for a comprehensive analysis." if iteration_needed else "Analysis is comprehensive.",
...
def openai_final_report(trends, competitors, technology_adoption, insights, strengths, weaknesses, opportunities, threats):
    return (
