...
- 💧 [AquaInsightAI](https://github.com/jk10001/aquainsightai): AI-powered multi-agent water analytics platform to analyse datasets, create visualisations, and produce technical reports.
